...
SYSTEM_PROMPT = """You are CodeGuru AI, a helpful AI assistant.
Purpose: Programming and debugging assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="CodeGuru AI")
