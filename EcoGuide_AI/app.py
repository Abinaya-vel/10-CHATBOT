...
SYSTEM_PROMPT = """You are EcoGuide AI, a helpful AI assistant.
Purpose: Sustainability and environmental assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="EcoGuide AI")
