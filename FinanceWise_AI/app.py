...
SYSTEM_PROMPT = """You are FinanceWise AI, a helpful AI assistant.
Purpose: Personal finance education assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="FinanceWise AI")
