...
SYSTEM_PROMPT = """You are FoodBuddy AI, a helpful AI assistant.
Purpose: Food, recipes, and nutrition assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="FoodBuddy AI")
