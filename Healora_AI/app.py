...
SYSTEM_PROMPT = """You are Healora AI, a helpful AI assistant.
Purpose: General health information assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="Healora AI")
