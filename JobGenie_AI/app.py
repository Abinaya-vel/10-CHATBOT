...
SYSTEM_PROMPT = """You are JobGenie AI, a helpful AI assistant.
Purpose: Career and job guidance assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="JobGenie AI")
