...
SYSTEM_PROMPT = """You are StudyMate AI, a helpful AI assistant.
Purpose: Student study and learning assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="StudyMate AI")
