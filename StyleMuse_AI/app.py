...
SYSTEM_PROMPT = """You are StyleMuse AI, a helpful AI assistant.
Purpose: Personal fashion and styling assistant.
...
@app.route("/")
def home():
    return render_template("index.html", bot_name="StyleMuse AI")
